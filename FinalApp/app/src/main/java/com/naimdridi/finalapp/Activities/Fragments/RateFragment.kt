...
class RateFragment : Fragment() {
    ...
    private fun setUpRecyclerView() {
        ...
        _view.recyclerViewRate.addOnScrollListener(scrollListener)
    }
    ...
    private fun removeFABIfRated(rated: Boolean){
        if (rated){
            _view.fabRating.hide()
            _view.recyclerViewRate.removeOnScrollListener(scrollListener)
        }
            ...
            .addSnapshotListener(object: java.util.EventListener, EventListener<QuerySnapshot> {
                override fun onEvent(snapshot: QuerySnapshot?, exception: FirebaseFirestoreException?) {
                    ...
                    snapshot?.let {
                        ...
                        _view.recyclerViewRate.smoothScrollToPosition(0)
                    }
                }
